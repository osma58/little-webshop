...
// $productCatalogue_food = new ProductCatalogue('food.json');
            ...
            <?php if ($shoppingCart->hasProducts()): ?>
                ...
                <?php foreach ($shoppingCart->getProducts() as $index => $product): ?>
                    <div class="shopping-cart__item">
                        <img src="<?php echo $product->getImage_url() ?>" alt="">
               ...
               <a href="cart.php?action=clear_all" class="verijder-alles button -dark center">Verwijder alles</a>
